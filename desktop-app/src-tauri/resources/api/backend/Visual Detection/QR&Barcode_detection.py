...
if os.path.exists(os.path.join(MODELS_DIR, "qr_barcode_detection", "best.pt")):
    model_path = os.path.join(MODELS_DIR, "qr_barcode_detection", "best.pt")
else:
    # Fallback to current directory for development
    current_dir = os.path.dirname(os.path.abspath(__file__))
    model_path = os.path.join(current_dir, "weights", "qr_barcode_detection", "best.pt")
